...
class PersistCalls
  ...
  def self.perform
    ...
    call_attempt_columns = [:status, :call_end, :connecttime, :caller_id, :scheduled_date, :recording_url, :recording_duration, :wrapup_time, :voter_response_processed]
    voter_columns = [:status, :call_back, :caller_id, :scheduled_date]
    Voter.import voter_columns, voters, :on_duplicate_key_update=>[:status, :call_back, :caller_id, :scheduled_date]
    CallAttempt.import call_attempt_columns, call_attempts, :on_duplicate_key_update=>[ :status, :call_end, :connecttime, :caller_id, :scheduled_date, :recording_url, :recording_duration, :wrapup_time, :voter_response_processed]
