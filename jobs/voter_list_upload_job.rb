  ...
  @queue = :voter_list_upload_worker_job
   ...
   def self.after_enqueue_scale_up(*args)
      ...
      if workers_to_scale > 0 && HerokuResqueAutoScale::Scaler.working_job_count('voter_list_upload_worker_job') < 3
        HerokuResqueAutoScale::Scaler.workers('report_download_worker_job', (HerokuResqueAutoScale::Scaler.working_job_count('voter_list_upload_worker_job') + HerokuResqueAutoScale::Scaler.pending_job_count('voter_list_upload_worker_job')))
      end
    end
