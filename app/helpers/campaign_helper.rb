module CampaignHelper
  ...
  def us_time_zone_select(field_name)
    select_tag(field_name,options_for_select([
        ["PST", "Pacific Time (US & Canada)"],["HST", "Hawaii"],["AKST", "Alaskan"],["MST", "Mountain Time (US & Canada)"],
        ["CST", "Central Time (US & Canada)"],["EST", "Eastern Time (US & Canada)"],
        ["AST", "Atlantic Time (Canada)"],["SST", "Samoa"]]))
  end
