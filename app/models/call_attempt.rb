...
class CallAttempt < ActiveRecord::Base
  ...
  def redirect_caller(account=TWILIO_ACCOUNT, auth=TWILIO_AUTH)
    unless caller_session.nil?
      t = TwilioLib.new(account, auth)    
      t.redirect_call(caller_session.sid, flow_caller_url(caller_session.caller, :host => Settings.host, :port => Settings.port, session_id: caller_session.id, event: "start_conf"))      
