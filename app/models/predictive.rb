class Predictive < Campaign
  ...
  def number_of_simulated_voters_to_dial
    ...
    available_callers = RedisCaller.on_hold(self.id) + RedisCampaignCall.above_average_inprogress_calls_count(self.id, best_conversation_simulated) + RedisCampaignCall.above_average_wrapup_calls_count(self.id, best_wrapup_simulated)
