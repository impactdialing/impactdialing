class Predictive < Campaign
  ...
  def number_of_simulated_voters_to_dial
    ...
    available_callers = RedisAvailableCaller.count(self.id) + RedisAvailableCaller.above_average_inprogress_calls_count(self.id, best_conversation_simulated) + RedisAvailableCaller.above_average_wrapup_calls_count(self.id, best_wrapup_simulated)
