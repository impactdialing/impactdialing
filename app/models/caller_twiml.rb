module CallerTwiml
  ...
  module InstanceMethods
    ...
    def connected_twiml
      Twilio::TwiML::Response.new do |r|
        r.Dial(:hangupOnStar => true, :action => pause_caller_url(caller_id, session_id:  id, host: DataCentre.call_back_host(data_centre), port:  Settings.twilio_callback_port, :protocol => "http://", :protocol => "http://")) do
