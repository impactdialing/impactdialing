...
class UserMailer
  ...
  def deliver_update_billing_info(account)
    ...
    content = "Your credit card was declined. Please update your <a href='https://admin.impactdialing.com/client/billing'>Billing Information</a>. If your balance fall below $0, you won't be able to make more phone calls. Reply to this message or call #{white_labeled_email(account.domain_name)} for support."
