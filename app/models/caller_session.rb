...
class CallerSession < ActiveRecord::Base
  ...
  def preview_dial(voter)
    ...
    params = {'FallbackUrl' => 'http://status-impactdialing.heroku.com/twilio/error', 'StatusCallback' => end_call_attempt_url(attempt, :host => Settings.host, :port => Settings.port),'Timeout' => campaign.answering_machine_detect ? "30" : "15"}
