class Call < ActiveRecord::Base
  ...
  call_flow :state, :initial => :initial do    
      ...
      state :connected do
        ...
        after(:always) { Resque.enqueue(CallPusherJob, call_attempt.id, "publish_voter_connected");Resque.enqueue(ModeratorCallJob, self.id, "publish_voter_connected_moderator")}
      ...
      state :disconnected do        
        ...
        after(:success) { Resque.enqueue(CallPusherJob, call_attempt.id, "publish_voter_disconnected");Resque.enqueue(ModeratorCallJob, self.id, "publish_voter_disconected_moderator") }                
