class Voter < ActiveRecord::Base
  ...
  def persist_answers(questions, call_attempt)
    ...
    question_answers.try(:each_pair) do |question_id, answer_id|
      ...
      answers.create(:possible_response => voters_response, :question => Question.find(question_id), :created_at => call_attempt.created_at, campaign: Campaign.find(campaign_id), :caller => call_attempt.caller)
