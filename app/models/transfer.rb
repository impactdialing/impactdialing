class Transfer < ActiveRecord::Base
  ...
  def dial(caller_session, call_attempt, voter, type)
    ...
    params = {'FallbackUrl' => TWILIO_ERROR, 'StatusCallback' => end_transfer_url(transfer_attempt, :host => Settings.twilio_callback_host, :port => Settings.twilio_callback_port),'Timeout' => "30"}
    response = Twilio::Call.make(voter.Phone, phone_number, connect_transfer_url(transfer_attempt, :host => Settings.twilio_callback_host, :port => Settings.twilio_callback_port),params)
