class Transfer < ActiveRecord::Base
  ...
  def dial(caller_session, call_attempt, voter)
    transfer_attempt = TransferAttempt.create(session_key: generate_session_key, transfer: self, campaign_id: caller_session.campaign_id, :status => CallAttempt::Status::RINGING, caller_session_id: caller_session.id, call_attempt_id: call_attempt.id)
