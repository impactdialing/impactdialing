class CallsController < ApplicationController
  ...
  def call_ended
    if ["no-answer", "busy", "failed"].include?(@parse_params['call_status'])
      RedisCall.store_call_details(@parse_params)
    end
    if @parse_params['campaign_type'] != Campaign::Type::PREDICTIVE
