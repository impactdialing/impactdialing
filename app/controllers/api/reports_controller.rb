module Api
  class ReportsController < ApiController
    ...
    def create
      ...
      set_date_range
      Delayed::Job.enqueue ReportJob.new(@campaign, user, params[:voter_fields], params[:custom_voter_fields], to_boolean(params[:download_all_voters]),to_boolean(params[:lead_dial]), @from_date, @to_date, params[:callback_url], "api")
