...
class TransferController < ApplicationController
  ...
  def caller
    ...
    response = Twilio::Verb.new do |v|
      v.dial(:hangupOnStar => true, action: flow_caller_url(caller, session_id:  caller_session.id, event: "pause_conf", host: Settings.twilio_callback_host, port:  Settings.twilio_callback_port)) do
