...
class TransferController < ApplicationController
  ...
  def caller
    ...
    response = Twilio::Verb.new do |v|
      v.dial(:hangupOnStar => true, action: pause_caller_url(caller, session_id:  caller_session.id, clear_active_transfer: true, host: Settings.twilio_callback_host, port:  Settings.twilio_callback_port, protocol: "http://")) do
