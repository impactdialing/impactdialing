    ...
    def download_report
      report = CSV.generate do |csv|
        ...
        @campaign.all_voters.answered_within(@from_date, @to_date).each do |v|
          custom_fields, answers, voter_details = [], [], [v.CustomID, v.LastName, v.FirstName, v.MiddleName, v.Suffix, v.Phone, v.last_call_attempt.caller.name, v.status, v.last_call_attempt.call_start, v.last_call_attempt.call_end, v.call_attempts.size, voter]
