  ...
  class ScriptsController < ::ScriptsController
    ...
    def update
      ...
      begin
        ...
        campaigns = @user.account.campaigns.with_running_caller_sessions.for_script(@script)
        
        if !params[:save_as] && !campaigns.empty?
          flash_message(:notice, I18n.t(:script_cannot_be_modified))
          render :show
          return
        end
