...
describe Client::QuestionsController do
  ...
  describe "show" do
    it "should return question " do
      ...
      response.body.should eq("{\"question\":{\"external_id_field\":null,\"id\":1,\"question_order\":null,\"script_id\":1,\"script_order\":1,\"text\":\"abc\"}}")
    end
  ...
  describe "create" do
    it "should create question" do
      ...
      response.body.should eq("{\"question\":{\"external_id_field\":null,\"id\":1,\"question_order\":null,\"script_id\":1,\"script_order\":1,\"text\":\"Hi\"}}")
    end
