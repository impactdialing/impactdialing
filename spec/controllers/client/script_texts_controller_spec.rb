...
describe Client::ScriptTextsController do
  ...
  describe "show" do
    it "should return script text" do
      ...
      response.body.should eq("{\"script_text\":{\"content\":\"abc\",\"id\":1,\"script_id\":1,\"script_order\":1}}")
    end
  ...
  describe "create" do
    it "should create script text" do
      ...
      response.body.should eq("{\"script_text\":{\"content\":\"Hi\",\"id\":2,\"script_id\":1,\"script_order\":1}}")
    end
