...
describe Api::LeadsController do
  ...
  it 'should throw an error if campaign does not belong to account ' do
    ...
    post :create, phone_number: "1234567890", campaign_id: @campaign.id, account_id: another_account.id, api_key: '1mp@ctd1@l1ng'
    result = JSON.parse(response.body)
  ...
  it 'should return success if lead is imported ' do
    post :create, phone_number: "1234567890", campaign_id: @campaign.id, account_id: @campaign.account_id, api_key: '1mp@ctd1@l1ng'
    result = JSON.parse(response.body)
  ...
  it "should create a voter list if none exist with name web form" do
    post :create, campaign_id: @campaign.id, phone_number: "1234567890", account_id: @campaign.account_id, api_key: '1mp@ctd1@l1ng'
