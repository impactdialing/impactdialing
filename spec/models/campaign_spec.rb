  ...
  describe Campaign do
    ...
    describe "abandon rate acceptable" do
      it "should return false if  not acceptable" do
        ...
        campaign.abandon_rate_acceptable?(campaign.call_attempts.size).should be_false
      end
      it "should return true if  acceptable" do
        ...
        campaign.abandon_rate_acceptable?(campaign.call_attempts.size).should be_true  
      end
