...
describe 'DoNotCall::Jobs::UnblockVoter' do
  ...
  let(:voters){ create_list(:voter, 10, :blocked, account: account, campaign: campaign) }
  ...
  let(:other_voters){ create_list(:voter, 10, :blocked, account: other_account, campaign: other_campaign) }
