...
describe RedisCall do
  ...
  it "should add the call params to the not answered list" do
    ...
    RedisCall.not_answered_call_list.pop.should eq({:call_id=>1234, :call_status=>"busy", :end_time=> Time.now.to_s})
  end
  ...
  it "should add the call params to the abandoned list" do
    ...
    RedisCall.abandoned_call_list.pop.should eq({:call_id=>1234, :call_status=>"in-progress", :connected_time=> Time.now.to_s})
  end


  it "should add the call params to the processing_by_machine list" do
    RedisCall.push_to_processing_by_machine_call_list({call_id: 1234, call_status: "in-progress"})
    RedisCall.processing_by_machine_call_list.length.should eq(1)
    RedisCall.processing_by_machine_call_list.pop.should eq({:call_id=>1234, :call_status=>"in-progress", :connected_time=> Time.now.to_s})
  end
  ...
  it "should add the call params to the processing_by_machine list" do
    ...
    RedisCall.end_answered_by_machine_call_list.pop.should eq({:call_id=>1234, :call_status=>"completed", :end_time=> Time.now.to_s})
  end
  ...
  it "should add the call params to the answered call list" do
    ...
    RedisCall.disconnected_call_list.pop.should eq({:call_id=>1234, :call_status=>"completed", :end_time=> Time.now.to_s})
  end
  ...
  it "should add the call params to the wrapup call list" do
    ...
    RedisCall.wrapped_up_call_list.pop.should eq({:call_id=>1234, :call_status=>"completed", :wrapup_time=> Time.now.to_s})
  end
