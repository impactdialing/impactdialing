...
describe RedisCallFlow, :type => :model do
  ...
  it "should add the call params to the not answered list" do
    ...
    expect(RedisCallFlow.not_answered_call_list.pop).to eq("{\"id\":1234,\"call_status\":\"busy\",\"current_time\":\"#{Time.now.utc.to_s}\"}")
  end
  ...
  it "should add the call params to the abandoned list" do
    ...
    expect(RedisCallFlow.abandoned_call_list.pop).to eq("{\"id\":1234,\"current_time\":\"#{Time.now.utc.to_s}\"}")
  end
  ...
  it "should add the call params to the processing_by_machine list" do
    ...
    expect(RedisCallFlow.processing_by_machine_call_hash['1234']).to eq(Time.now.utc.to_s)
  end
  ...
  it "should add the call params to the end_by_machine list" do
    ...
    expect(RedisCallFlow.end_answered_by_machine_call_list.pop).to eq("{\"id\":1234,\"current_time\":\"#{Time.now.utc.to_s}\"}")
  end
  ...
  it "should add the call params to the answered call list" do
    ...
    expect(RedisCallFlow.disconnected_call_list.pop).to eq("{\"id\":1234,\"recording_duration\":15,\"recording_url\":\"url\",\"caller_id\":1,\"current_time\":\"#{Time.now.utc.to_s}\"}")
  end
  ...
  it "should add the call params to the wrapup call list" do
    ...
    expect(RedisCallFlow.wrapped_up_call_list.pop).to eq("{\"id\":1234,\"caller_type\":\"Twilio client\",\"voter_id\":42,\"current_time\":\"#{Time.now.utc.to_s}\"}")
  end  
end
