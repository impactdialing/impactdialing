...
describe Answer do
  it "should returns all the answers within the specified period" do
    ...
    Answer.within(Time.now, Time.now + 1.day).should == [answer3, answer4]
    Answer.within(Time.now + 2.day, Time.now + 3.day).should == []
    Answer.within(Time.now, Time.now).should == [answer3, answer4]
  end
end
