...
describe Pro do
  ...
  describe "campaign" do
    let(:account) { create(:account, subscription_name: Subscription::Type::PRO) }
  ...
  describe "transfers" do
    let(:account) { create(:account, subscription_name: Subscription::Type::PRO, record_calls: false) }
