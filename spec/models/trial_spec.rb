...
describe Trial do
  ...
  #     Stripe::Customer.should_receive(:retrieve).with("123").and_return(customer)
  #     customer.should_receive(:update_subscription).with({:quantity=>1, :plan=>"ImpactDialing-Pro", :prorate=>true}).and_return(subscription)
  #     Stripe::Invoice.should_receive(:create).and_return(invoice)
  #     invoice.should_receive(:pay)
  #     subscription.should_receive(:customer).and_return("123")
  #     subscription.should_receive(:plan).and_return(plan)
  ...
  #     Stripe::Customer.should_receive(:retrieve).with("123").and_return(customer)
  #     customer.should_receive(:update_subscription).with({:quantity=>1, :plan=>"ImpactDialing-Business", :prorate=>true}).and_return(subscription)
  #     Stripe::Invoice.should_receive(:create).and_return(invoice)
  #     invoice.should_receive(:pay)
  #     subscription.should_receive(:customer).and_return("123")
  #     subscription.should_receive(:plan).and_return(plan)
