...
describe TimeZoneHelper do
  ...
  describe "set_date_range_account" do
     ...
     it "should format fromdate and to date if present" do
       account = create(:account)
       helper.set_date_range_account(account, "08/08/2012", "08/09/2012").to_s.should eq([Time.parse("2012-08-08 00:00:00 UTC"), Time.parse("2012-08-09 23:59:59 UTC")].to_s)
     end

     it "should format accounts created date if no date present " do
       campaign = create(:account, created_at: "2012-08-01 10:00:00 UTC")
       helper.set_date_range_account(campaign, nil, nil)[0].to_s.should eq(Time.parse("2012-08-01 00:00:00 UTC").to_s)
     end
