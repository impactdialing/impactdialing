...
describe TimeZoneHelper do
  ...
  describe "set_date_range" do
     ...
     it "should format campaigns first and last attempt if from and to not present" do
       campaign = Factory(:campaign, time_zone: "Eastern Time (US & Canada)")
       call_attempt1 = Factory(:call_attempt, campaign: campaign, created_at: "2012-08-08 10:00:00 UTC")
       call_attempt2 = Factory(:call_attempt, campaign: campaign, created_at: "2012-08-11 09:00:00 UTC")
  ...
  describe "set_date_range_account" do
     ...
     it "should format accounts created date if no date present " do
       campaign = Factory(:account, created_at: "2012-08-01 10:00:00 UTC")
