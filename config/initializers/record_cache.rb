...
if Rails.env == 'heroku' || Rails.env == "heroku_staging"
  RecordCache::Base.version_store = ActiveSupport::Cache.lookup_store(:dalli_store)
  RecordCache::Base.register_store(:local, ActiveSupport::Cache.lookup_store(:dalli_store))
  RecordCache::Base.register_store(:shared, ActiveSupport::Cache.lookup_store(:dalli_store))
else
