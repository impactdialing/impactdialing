...
VoterLists.prototype.validate_csv_file = function(evt){
  ...
  reader.onload = function(theFile) {
    ...
    $.get("/client/campaigns/"+$('#campaign_id').val()+"/voter_lists/column_mapping", {headers: csv_column_headers, first_data_row: csv_column_data},function(data) {
      ...
      $("#voter_list_headers").val("[" + csv_column_headers + "]")
      $("#list_name").show();
      $("#voter_upload").show();
  });
...
VoterLists.prototype.column_mappings = function(campaign_id, csv_column_headers, separator){
$.get("/client/campaigns/"+campaign_id+"/voter_lists/column_mapping", {headers: csv_column_headers},function(data) {
  $('#column_headers').html(data);
